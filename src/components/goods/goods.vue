    ...
    <div>
      <div class="goods">
        <div class="menu-wrapper" ref="menuWrapper">
          <ul>
            <li v-for="(item, index) in goods" :key="item.id" :index="index" class="menu-item"
              :class="{'current':currentIndex === index}" @click="selectMunu(index, $event)">
              ...
              <ul>
                <li @click="selectFood(food, $event)" v-for="food in item.foods" :key="food.id" class="food-item">
                  <div class="image-icon">
                    <img :src="food.icon" width="58px" height="57px" alt="">
                  </div>
                  <div class="content">
