        ...
        <div class="food-content">
          <div class="image-header">
            ...
            <div class="back" @click="hide">
              <svg class="icon icon-arrow_lift" aria-hidden="true">
          ...
          <div class="content">
            ...
            <div @click="addFirst($event)" class="buy" v-show="!food.count || food.count === 0">购物车</div>
          </div>
              ...
              <ul v-show="food.ratings && food.ratings.length">
                <li v-show="needShow(rating.rateType,rating.text)" class="rating-item" v-for="(rating, index) in food.ratings" :key="index">
                  <div class="user">
                    ...
                    <img :src="rating.avatar" width="12" class="avatar">
                  </div>
                  <div class="time">{{rating.rateTime | formatDate}}</div>
                  <p class="text">
                    <svg :class="{'icon icon-thumb_up':rating.rateType===0,
                      'icon icon-thumb_down':rating.rateType===1}" aria-hidden="true">
                      <use v-show="rating.rateType===0" xlink:href="#icon-thumb_up"></use>
                      <use v-show="rating.rateType===1" xlink:href="#icon-thumb_down"></use>
                    </svg>{{rating.text}}
                  </p>
                </li>
              </ul>
...
@import "../../common/sass/base.scss";
  ...
  .fade-food-enter, .fade-food-leave-to {
